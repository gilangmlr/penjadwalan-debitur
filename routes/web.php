...
Route::get('/view-admin-users', 'AdminController@view_users')->name('view-admin-users');
...
Route::post('/crud-admin-users-edit', 'AdminController@crud_users_edit')->name('crud-admin-users-edit');
