...
Route::get('/view-akad-monitor', ['middleware' => ['ability:admin|pantau-akad-role,pantau-akad'], 'uses' => 'AkadController@view_monitor'])->name('view-akad-monitor');
...
Route::post('/crud-akad-create', ['middleware' => ['ability:admin|buat-akad-role,buat-akad'], 'uses' => 'AkadController@crud_create'])->name('crud-akad-create');
